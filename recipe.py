...
blacklist = ["cup", "teaspoon", "teaspoons", "cups", "tablespoons", "tablespoon", "medium", "large", "small", "ounce",
...
for ingredient in ingredients:
    ...
    ingr = []
    for token in var:
        if token.pos_ == "NOUN" and str(token) not in blacklist and _filter(token):
