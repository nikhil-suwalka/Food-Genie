"""
Django settings for food_genie project.
...
SECRET_KEY = 'cod@fi4y78cw_dl1!mo6y44n(sc)_y03ac_k4t5jnkl43)=qtp'
...
WSGI_APPLICATION = 'food_genie.wsgi.application'
